    ...
    function submit_post() {
        ...
        if ( $post_id ) {
            ...
            if($post_author != 1){
                ...
                $org_attachment_post = array(
                     'post_mime_type' => $org_mime_type,
                     'post_title' => $originalName,
                     'post_content' => '',
                     'post_status' => 'inherit'
                );
...
*/
                    ...
                    $attachment_post = array(
                     ...
                     'post_title' => $colImgName,
                     'post_content' => '',
                     'post_status' => 'inherit',
                     //'guid' => $media_upload_url.'/'.$colImgName.'.png'
                    );
                    // Insert the attachment.
                    $colAttach_id = wp_insert_attachment( $attachment_post, $colImgPath, $post_id );

                    // Set wp_attachment_metadata
                    $the_attach_data = array(
                        'width'=>1000,
                        'height'=>1000,
//                        'hwstring_small'=> height="500" width="500"
                        'file'=> $colImgName.'.png',
                        'sizes'=> array(
                            'shop_single'=>array(
                                'file'=> $colImgName_half.'.png',
...
//                        update_post_meta( $post_id, '_thumbnail_id' , $colAttach_id);
                    ...
                    $var_post = array(
                            'post_title'    => 'Variation #' . $i . ' of ' . $this_post_title,
                            'post_author'   => $post_author,
