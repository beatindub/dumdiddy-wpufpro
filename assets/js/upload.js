    ...
    WPUF_Uploader.prototype = {
        ...
        showHide: function () {
            ...
            if ( this.count >= this.max) {
                ...
                $('.wpuf-custom-help').hide();
                $('.wpuf-custom-help-original-product').hide();

                return;
            };

            $('#' + this.container).find('.file-selector').show();
            $('.wpuf-custom-help').show();
            $('.wpuf-custom-help-original-product').show();
        },
        ...
        added: function (up, files) {
            ...
            $.each(files, function(i, file) {
                $container.append(
                    ...
                    'Uploading...' + ' (' + plupload.formatSize(file.size) + ') <b></b>' +
                    '</div></div>');
            });
